...
public final class FindMeetingQueryTest {
  ...
  @Test
  public void everyAttendeeIsConsideredOptionalWholeDay() {
      Collection<Event> events = Arrays.asList(
        new Event("Event 1", TimeRange.fromStartDuration(TIME_0800AM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_A)),
        new Event("Event 2", TimeRange.fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
  ...
  public void noMandatoryAttendeesWithGaps() {
      Collection<Event> events = Arrays.asList(
        ...
        new Event("Event 3", TimeRange.fromStartDuration(TIME_1100AM, DURATION_60_MINUTES),
            Arrays.asList(PERSON_A)),
        new Event("Event 4", TimeRange.fromStartDuration(TIME_0300PM, DURATION_30_MINUTES),
            Arrays.asList(PERSON_B)));
      ...
      Collection<TimeRange> expected = 
          Arrays.asList(TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_0830AM, false),
              ...
              TimeRange.fromStartDuration(TIME_1200PM, DURATION_3_HOUR),
              TimeRange.fromStartEnd(TIME_0330PM, TimeRange.END_OF_DAY, true));
